...
void _userSettingsSerialize(
  ...
  writer.writeBool(offsets[0], object.isAuthenticated);
...
extension UserSettingsQueryFilter
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterFilterCondition>
      isAuthenticatedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension UserSettingsQuerySortBy
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterSortBy>
      sortByIsAuthenticatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAuthenticated', Sort.desc);
    });
  }

  QueryBuilder<UserSettings, UserSettings, QAfterSortBy> sortByIsFirstTime() {
    return QueryBuilder.apply(this, (query) {
...
extension UserSettingsQuerySortThenBy
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterSortBy>
      thenByIsAuthenticatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAuthenticated', Sort.desc);
    });
  }

  QueryBuilder<UserSettings, UserSettings, QAfterSortBy> thenByIsFirstTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFirstTime', Sort.asc);
    });
  }
...
extension UserSettingsQueryWhereDistinct
  ...
  QueryBuilder<UserSettings, UserSettings, QDistinct>
      distinctByIsAuthenticated() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isAuthenticated');
    });
  }

  QueryBuilder<UserSettings, UserSettings, QDistinct> distinctByIsFirstTime() {
    return QueryBuilder.apply(this, (query) {
...
extension UserSettingsQueryProperty
  ...
  QueryBuilder<UserSettings, bool, QQueryOperations> isAuthenticatedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isAuthenticated');
    });
  }

  QueryBuilder<UserSettings, bool, QQueryOperations> isFirstTimeProperty() {
    return QueryBuilder.apply(this, (query) {
